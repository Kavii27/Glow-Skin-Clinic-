...
//#region node_modules/.nitro/vite/services/ssr/assets/SectionHeading-Ch6lScgU.js
var import_jsx_runtime = require_jsx_runtime();
var cat_rejuvenation_default = "/assets/cat-rejuvenation-BrMA4Uzu.jpg";
var cat_laser_default = "/assets/cat-laser-KDBF2VHo.jpg";
var cat_antiaging_default = "/assets/cat-antiaging-DZx0ryTW.jpg";
var blog1_default = "/assets/blog1-C-U79qAU.jpeg";
var blog2_default = "/assets/blog2-J0FcDHPc.jpeg";
var blog3_default = "/assets/blog3-CNT75S7g.jpeg";
var cat_body_default = "/assets/cat-body-Bek18wuS.jpg";
var ba_1_before_default = "/assets/ba-1-before-Bj3LwtYx.jpg";
var ba_1_after_default = "/assets/ba-1-after-CvYf9GvN.jpg";
var ba_2_before_default = "/assets/ba-2-before-Du0-BbPP.jpg";
var ba_2_after_default = "/assets/ba-2-after-D9of65hW.jpg";
var clinic_interior_default = "/assets/clinic-interior-BH-qkZaH.jpg";
var doctor_portrait_default = "/assets/doctor-portrait-DTZJ6ldA.jpg";
var placeholder_result_default = "/assets/placeholder-result-L0-Ebwon.jpg";
var anti_aging_before_after_default = "/assets/anti-aging-before-after-D7AsUEK6.jpg";
var CLINIC = {
...
var mapEmbedUrl = `${CLINIC.googleMapsPlaceUrl}&output=embed`;
var googleMapsUrl = CLINIC.googleMapsPlaceUrl;
var findBlogPostBySlug = (slug) => blogPosts.find((p) => p.slug === slug);
var whatsappLink = (message) => `https://wa.me/${CLINIC.whatsapp}?text=${encodeURIComponent(message)}`;
var treatmentCategories = [
	{
		slug: "skin-rejuvenation",
		title: "Skin Rejuvenation",
		tagline: "Restore luminosity, clarity and a refined skin texture.",
		image: cat_rejuvenation_default,
		treatments: [
			{
				name: "Anti-Aging Treatment",
				blurb: "Medical-grade protocols that soften lines and restore firmness.",
				detail: "A tailored combination of collagen-stimulating therapies designed around your skin's biology, delivering a naturally rested and lifted appearance over a graded course.",
				duration: "45–60 min",
				...
				resultImage: anti_aging_before_after_default
			},
			{
				name: "Skin Whitening & Rejuvenation",
				blurb: "Even tone, luminous clarity, no compromise on skin health.",
				detail: "Physician-formulated brightening protocols targeting melanin activity and dullness, combining topical actives, in-clinic infusions and light-based correction.",
				duration: "40 min",
				...
				resultImage: placeholder_result_default
			},
			{
				name: "PRP / PRF Treatment",
				blurb: "Your own growth factors, harnessed for genuine regeneration.",
				detail: "Platelet-rich plasma and fibrin concentrates are prepared from your own blood and reintroduced to stimulate collagen, improve texture and revive tired skin.",
				duration: "60 min",
			...
			},
			{
				...
				detail: "Precision micro-channels trigger the skin's repair cascade, refining pores, scarring and fine lines while enhancing absorption of medical serums.",
				duration: "45 min",
			...
			},
			{
				...
				detail: "A multi-step resurfacing ritual that cleanses, exfoliates, extracts and saturates the skin with antioxidants and peptides. Zero downtime.",
				duration: "50 min",
				...
				sideEffects: ["Mild, temporary redness immediately after treatment", "Rare: slight tightness in very sensitive skin"],
				aftercare: [
			...
			},
			{
				...
				detail: "Medical peels at carefully selected depths to address pigmentation, congestion and dullness, always prescribed after a full skin assessment.",
				duration: "30 min",
				...
				idealFor: ["Uneven pigmentation, mild acne scarring or dull texture", "Patients who have completed a full skin assessment beforehand"],
				sideEffects: [
			...
			},
			{
				...
				detail: "Mechanical micro-exfoliation lifts dulling surface cells and refines congested pores, leaving skin smoother with no downtime.",
				duration: "30 min",
				...
				idealFor: ["Dull, rough or congested skin", "Patients wanting a gentle, low-risk polishing treatment"],
				sideEffects: ["Mild, temporary redness or sensitivity", "Rare: light dryness for a day"],
				aftercare: [
			...
			},
			{
				...
				detail: "A medical-grade carbon layer is drawn into pores then vaporised with laser energy, lifting debris, minimising pores and refining texture.",
				duration: "30–40 min",
				...
				idealFor: ["Oily or congested skin", "Enlarged pores and mild acne-prone skin"],
				sideEffects: ["Mild warmth, redness or tightness immediately after", "Rare: temporary sensitivity in reactive skin"],
				aftercare: [
					"Apply SPF 30+ daily",
			...
			},
			{
				...
				detail: "A concentrated collagen-based protocol addressing anti-aging concerns, dry and dull skin, and hair thinning through targeted infusion and stimulation techniques.",
				duration: "45–60 min",
				...
				idealFor: ["Early ageing, dryness or dullness", "Patients wanting a combined skin-and-hair vitality protocol"],
				sideEffects: ["Mild redness or swelling at infusion or injection points", "Temporary tenderness for a day or two"],
				aftercare: [
			...
			},
			{
				...
				detail: "A dedicated protocol combining barrier-repair actives and in-clinic therapies to calm, hydrate and even out rough, flaking or uneven skin.",
				duration: "40 min",
				...
				idealFor: ["Chronically dry, flaking or rough skin", "Patients with a compromised or sensitised skin barrier"],
				sideEffects: ["Mild stinging or redness on application in very reactive skin", "Rare: temporary flare-up before improvement"],
				aftercare: [
	...
	},
	{
		...
		image: cat_laser_default,
		treatments: [
			{
				name: "Pico Laser",
				blurb: "Ultra-short pulses that shatter pigment gently.",
				detail: "Picosecond energy fragments unwanted pigment and stimulates dermal remodelling with minimal thermal impact — ideal for melasma, sun damage and tattoo removal.",
				duration: "30 min",
			...
			},
			{
				...
				detail: "Intense pulsed light targets vascular and pigmented irregularities, leaving a clearer, more even complexion across a short treatment course.",
				duration: "35 min",
				...
				idealFor: ["Redness, rosacea-prone skin or sun damage", "Uneven skin tone from vascular or pigment concerns"],
				sideEffects: [
			...
			},
			{
				...
				detail: "Cooled diode technology delivers consistent, comfortable energy to the follicle across all treatable skin types.",
				duration: "20–60 min",
				...
				idealFor: ["Unwanted facial or body hair", "Most skin tones, assessed individually before treatment"],
				sideEffects: ["Mild redness or slight swelling around follicles", "Rare: temporary pigment changes in sensitive skin"],
				aftercare: [
			...
			},
			{
				...
				detail: "A structured protocol across growth cycles for face and body, planned to your hair density, skin tone and desired result.",
				duration: "20–60 min",
				...
				idealFor: ["Anyone seeking a long-term alternative to shaving or waxing", "Most skin types, assessed individually beforehand"],
				sideEffects: ["Mild redness, swelling or a warm sensation around follicles", "Rare: temporary pigment changes or, very rarely, blistering"],
				aftercare: [
					"Avoid sun exposure and apply SPF between sessions",
			...
			},
			{
				...
				detail: "Combination therapy uniting laser, medical topicals and photoprotection strategy for durable, relapse-aware pigment control.",
				duration: "30–45 min",
				...
				idealFor: ["Melasma, freckles and stubborn pigmentation", "Patients wanting a structured, medically supervised plan rather than a single quick fix"],
				sideEffects: [
	...
	},
	{
		...
		image: cat_antiaging_default,
		treatments: [
			{
				name: "Botox — Face / Hands / Armpits",
				blurb: "Softened expression lines and control of excess sweating.",
				detail: "Micro-dosed neuromodulation placed with anatomical precision for facial lines, rejuvenated hands, or underarm hyperhidrosis, so movement and comfort stay natural.",
				duration: "20–40 min",
				...
				idealFor: ["Dynamic wrinkles caused by repeated facial expression", "Hyperhidrosis of the hands or underarms"],
				sideEffects: [
			...
			},
			{
				...
				detail: "Hyaluronic acid artistry and PDO thread placement for cheeks, lips, chin, jawline and tear troughs — always structural first, decorative second.",
				duration: "45–60 min",
				...
				idealFor: ["Volume loss, flattened cheeks or a tired-looking mid-face", "Patients wanting subtle, balanced enhancement"],
				sideEffects: [
			...
			},
			{
				...
				detail: "Absorbable PDO threads reposition soft tissue and stimulate collagen along the jawline, mid-face and neck.",
				duration: "60 min",
				...
				idealFor: ["Mild to moderate skin laxity and early sagging", "Patients seeking a non-surgical lifting option"],
				sideEffects: [
			...
			},
			{
				...
				detail: "High-intensity focused ultrasound reaches the foundational layers to firm and contour sagging skin progressively over three to six months.",
				duration: "60–90 min",
				...
				idealFor: ["Mild to moderate skin laxity of the face, jawline or neck", "Patients wanting a non-invasive alternative to a facelift"],
				sideEffects: ["Temporary redness, swelling or tenderness", "Rare: transient numbness or tingling that resolves on its own"],
				aftercare: [
			...
			},
			{
				...
				detail: "Semi-permanent pigmentation or brightening protocols restore a healthy, even lip tone and definition for a naturally polished finish.",
				duration: "60–90 min",
				...
				idealFor: ["Naturally dark, pigmented or uneven-toned lips", "Anyone wanting subtle, long-lasting lip definition"],
				sideEffects: [
	...
	},
	{
		...
		image: cat_body_default,
		treatments: [
			{
				name: "Hair Loss Treatment",
				blurb: "Medical diagnosis before any prescription.",
				detail: "Trichological assessment followed by PRP, mesotherapy, low-level laser and prescription therapy tailored to the cause of your shedding.",
				duration: "45 min",
				...
				idealFor: ["Early to moderate hair thinning or shedding", "Patients wanting a diagnosis-first approach before treatment"],
				sideEffects: ["Mild scalp tenderness, redness or swelling after PRP/mesotherapy", "Rare: temporary shedding before regrowth (a recognised part of the process)"],
				aftercare: [
			...
			},
			{
				...
				detail: "Fractional resurfacing and microneedling with growth factors to rebuild dermal architecture and soften striae and old scarring.",
				duration: "45 min",
				...
				idealFor: ["Stretch marks (recent or older)", "Old surgical, injury or acne scarring"],
				sideEffects: ["Redness, swelling or pinpoint bleeding at the treated site", "Mild tenderness for a few days"],
				aftercare: [
			...
			},
			{
				...
				detail: "Ultrasonic cavitation technology targets localised fat deposits around the double chin, abdomen, thighs and arms, planned alongside realistic, medically sound expectations.",
				duration: "45–60 min",
				...
				idealFor: ["Localised fat deposits resistant to diet and exercise", "Patients seeking a non-surgical contouring option, not a weight-loss substitute"],
				sideEffects: ["Mild redness, warmth or tingling in the treated area", "Rare: temporary bruising or tenderness"],
				aftercare: [
			...
			},
			{
				...
				detail: "Platelet-rich plasma and fibrin concentrates prepared from your own blood, used to support tissue repair and comfort in body areas and knee joints.",
				duration: "45–60 min",
				...
				idealFor: ["Patients wanting a regenerative approach for body areas or knee joints", "Those who prefer treatments using their own biological material"],
				sideEffects: ["Redness, swelling or bruising at injection sites", "Mild soreness for a day or two, similar to a minor strain"],
				aftercare: [
			...
			},
			{
				...
				detail: "A staged medical approach combining peels, laser, microneedling and topical therapy to calm active breakouts and resurface acne scarring.",
				duration: "40–60 min",
				...
				idealFor: ["Active acne or acne-prone skin", "Post-acne scarring and pigmentation"],
				sideEffects: [
			...
			},
			{
				...
				detail: "Clinical removal of warts, lumps, spots and naevi using the most appropriate energy-based or minor-procedure technique, assessed individually for the safest outcome.",
				duration: "20–40 min",
				...
				idealFor: ["Unwanted, benign skin growths affecting appearance or comfort", "Patients who want any new or changing lesion medically assessed first"],
				sideEffects: ["Mild redness, scabbing or a small mark during healing", "Rare: infection or scarring if aftercare is not followed"],
				aftercare: [
			...
			},
			{
				...
				detail: "Performed in a sterile clinical setting with precision placement and aftercare guidance, suitable for both adults and children.",
				duration: "15–20 min",
				...
				idealFor: ["Adults and children wanting a hygienic, medically supervised piercing"],
				sideEffects: ["Mild redness, tenderness or swelling at the site", "Rare: infection if aftercare instructions are not followed"],
				aftercare: [
...
function slugify(name) {
	return name.toLowerCase().replace(/\//g, " ").replace(/—/g, " ").replace(/&/g, "and").replace(/[^a-z0-9]+/g, "-").replace(/-+/g, "-").replace(/^-|-$/g, "");
}
function findTreatmentBySlug(slug) {
...
var beforeAfterCases = [{
	...
	before: ba_1_before_default,
	after: ba_1_after_default
}, {
	title: "Fine Lines & Skin Laxity",
	protocol: "HIFU + PRP · 3 sessions",
	before: ba_2_before_default,
	after: ba_2_after_default
}];
var testimonials = [
	{
		name: "Nethmi R.",
		...
		rating: 5,
		quote: "From the moment I walked in, it felt like a private atelier rather than a clinic. Dr. Apeksha explained every step, and my pigmentation has faded beyond what I hoped for."
	},
	{
		name: "Sanduni P.",
		treatment: "PRP & Microneedling",
		rating: 5,
		quote: "I have never been treated with such care. The results are subtle in the best way — people simply tell me my skin looks well, not that I have had something done."
	},
	{
		name: "Ayesha M.",
		treatment: "Thread Lift",
		rating: 5,
		quote: "Meticulous, honest and utterly professional. She talked me out of what I did not need and delivered exactly what I did. That earns real trust."
	},
	{
		name: "Dilini K.",
		treatment: "Laser Hair Removal",
		rating: 5,
		quote: "The most comfortable sessions I have experienced anywhere, and the clinic itself is beautiful. Six sessions in and the difference is remarkable."
	},
	{
		name: "Hasini W.",
		treatment: "Anti-Aging Programme",
		rating: 5,
		quote: "A genuinely medical approach wrapped in luxury. My skin has not looked this rested in a decade."
	},
	{
		name: "Tharushi S.",
		treatment: "Facial Fillers",
		rating: 5,
		quote: "Natural, balanced and elegant. Dr. Apeksha has an artist's eye and a physician's discipline."
	}
];
var doctorProfile = {
	...
	paragraphs: ["Dr. Apeksha Herath combines evidence-based medicine with advanced aesthetic training to deliver natural, balanced, and patient-focused results. A medical graduate of the University of Peradeniya, she believes every patient deserves a personalised treatment plan built on facial anatomy, skin biology, and long-term skin health — never a one-size-fits-all procedure.", "Her expertise is continually refined through specialised training in cosmetic dermatology, facial injectables, laser medicine, and non-surgical facial rejuvenation, so every treatment at Glow Skin Clinic reflects current evidence and modern technique."],
	closing: "Her goal is simple: to help every patient feel more confident through safe, ethical, medically guided aesthetic care."
};
var professionalPhilosophy = {
	eyebrow: "Professional Philosophy",
	description: "Instead of chasing cosmetic trends, Dr. Herath believes aesthetic medicine should enhance confidence while preserving individuality. Every treatment begins with a detailed consultation, medical assessment, and discussion of realistic expectations. Safety, ethics, and long-term skin health remain at the centre of every recommendation."
};
var whyChoose = [
...
var milestones = [
	...
	},
	{
		...
		description: "Following her medical degree, Dr. Herath undertook an extended period of hands-on clinical training alongside a team of experienced aesthetic physicians. This apprenticeship-style training focused on live-patient injection technique, facial assessment under supervision, sterile procedure protocols, and — critically — how to recognise and manage complications before they become serious. Working directly under senior practitioners allowed her to build the kind of practical judgement that cannot be taught from a textbook: reading individual facial anatomy, adjusting technique in real time, and understanding when a patient is not a suitable candidate for a given treatment.",
...
var faqs = [
	{
		...
		answer: "Yes. Every patient begins with a private consultation with Dr. Apeksha Herath so the protocol can be tailored to your skin, medical history and goals before any treatment is scheduled."
	},
	{
		question: "Are the treatments performed by a doctor?",
		answer: "All procedures at Glow Skin Clinic are prescribed and performed personally by Dr. Apeksha Herath — nothing is delegated to unqualified staff."
	},
	{
		question: "How much downtime should I expect?",
		answer: "It depends on the treatment. Many of our laser and injectable protocols have little to no visible downtime, while more intensive procedures may need a few days of recovery. This is discussed in detail during your consultation."
	},
	{
		question: "How many sessions will I need to see results?",
		answer: "Most treatment plans are structured as a course of sessions rather than a single visit, since skin responds best to a gradual, medically guided protocol. Your doctor will outline an expected timeline for your specific goals."
	},
	{
		question: "Is it safe for sensitive or acne-prone skin?",
		answer: "Every protocol is selected after a full skin assessment, so treatments are adapted for sensitive, acne-prone or reactive skin types rather than applied as a one-size-fits-all approach."
	},
	{
		question: "How do I book an appointment?",
		answer: "You can request a consultation through the Book a Consultation page, or message us directly on WhatsApp for a faster response."
	}
];
var galleryImages = [
	{
		src: clinic_interior_default,
		alt: "Reception and waiting lounge",
		category: "Clinic"
	},
	{
		src: cat_rejuvenation_default,
		alt: "Skin rejuvenation treatment room",
		category: "Treatments"
	},
	{
		src: cat_laser_default,
		alt: "Laser treatment suite",
		category: "Treatments"
	},
	{
		src: cat_antiaging_default,
		alt: "Anti-aging consultation room",
		category: "Treatments"
	},
	{
		src: cat_body_default,
		alt: "Body care treatment suite",
		category: "Treatments"
	},
	{
		src: ba_1_after_default,
		alt: "Skin rejuvenation result",
		category: "Results"
	},
	{
		src: ba_2_after_default,
		alt: "Laser treatment result",
		category: "Results"
	},
	{
		src: doctor_portrait_default,
		alt: "Dr. Apeksha Herath",
		category: "Clinic"
	}
];
var blogPosts = [
	{
		...
		excerpt: "Pico, fractional, diode — the range of laser platforms can be confusing. Here's how a proper assessment narrows it down to what your skin actually needs.",
		content: [
	...
	},
	{
		...
		excerpt: "A look at what a typical rejuvenation protocol involves, from the initial assessment through to aftercare.",
		content: [
	...
	},
	{
		...
		excerpt: "Simple preparation steps that make a real difference to comfort, downtime and results.",
		content: [
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "mt-4 text-4xl leading-[1.1] text-foreground sm:text-5xl",
				children: title
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: isCenter ? "mx-auto mt-6 w-20" : "mt-6 w-20",
...
//#endregion
export { slugify as _, blogPosts as a, whatsappLink as b, doctor_portrait_default as c, findTreatmentBySlug as d, galleryImages as f, professionalPhilosophy as g, milestones as h, beforeAfterCases as i, faqs as l, mapEmbedUrl as m, GoldLine as n, clinic_interior_default as o, googleMapsUrl as p, SectionHeading as r, doctorProfile as s, CLINIC as t, findBlogPostBySlug as u, testimonials as v, whyChoose as x, treatmentCategories as y };
